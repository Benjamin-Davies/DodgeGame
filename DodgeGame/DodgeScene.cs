...
namespace DodgeGame
{
    public partial class DodgeScene : UserControl, IScene
    {
        ...
        public DodgeScene(Form _form, Navigator _navigator, string _username, int _lifeCount)
        {
        ...
        private void DodgeScene_Enter(object sender, EventArgs e)
        {
            mouseOverWindow = true;
        }

        public void DodgeScene_Leave(object sender, EventArgs e)
        {
